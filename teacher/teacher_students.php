...
if ($subject_filter && isset($conn)) {
    $students_sql = "
        SELECT DISTINCT
            ...
            (SELECT COUNT(*) FROM lab_attendance a 
             JOIN lab_admission adm2 ON a.admission_id = adm2.admission_id
             JOIN lab_schedule sc2 ON adm2.schedule_id = sc2.schedule_id
