...
try {
    ...
    // Drop foreign key constraint FROM lab_attendance table
    $drop_attendance_fk = $conn->query("ALTER TABLE `lab_attendance` DROP FOREIGN KEY IF EXISTS fk_attendance_semester");
    ...
    $modify_attendance = $conn->query("ALTER TABLE `lab_attendance` MODIFY COLUMN semester_id INT NULL");
