...
$subj_sql = "SELECT subj.subject_name FROM lab_schedule sc JOIN lab_subject subj ON sc.subject_id=subj.subject_id WHERE sc.employee_id=? GROUP BY subj.subject_id, subj.subject_name ORDER BY subj.subject_name";
