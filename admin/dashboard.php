...
$stmtTotal = $conn->prepare("SELECT COUNT(*) AS cnt FROM lab_attendance WHERE attendance_date = ?");
...
$stmtDrill = $conn->prepare("SELECT yl.year_name AS year_level,
                               ...
                               JOIN lab_section sct    ON ad.section_id = sct.section_id
    ...
    <main class="pt-8">
        ...
        <section class="stat-cards">
            ...
            <div class="card">
                ...
                <p><?= $conn->query("SELECT COUNT(*) AS cnt FROM lab_employees WHERE role IN ('Dean','Faculty')")->fetch_assoc()['cnt'] ?></p>
            </div>
            <div class="card">
